...
public class AgentW2 extends Agent {
            ...
            public void action() {
                ...
                if (msg != null){
                    ...
                    try {
                        ...
                        PreparedStatement st = con.prepareStatement("SELECT \"SibSp\" , \"Parch\" from public.\"FamilyData\" where \"PassengerId\"=?");
                        ...
                        msg1.setConversationId("from-w2-to-ws");
